    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tableau Reservation Tickets</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tableau Tickets verifier</h5>
              <a href="formTicket.php" class="btn btn-primary ">Add Ticket</a>
              <a href="pdf.php" class="btn btn-primary ">Generate pdf tickets list</a>
              ...
              <table class="table datatable">
                ...
                <tr>
                    ...
                    <td><?= $ticket['nom']; ?></td>
                    <td><?= $ticket['prenom']; ?></td>
                    <td><?= $ticket['nomEvenement']; ?></td>
                    <td><?= $ticket['dateEvenement']; ?></td>
                    <td><?= $ticket['seat']; ?></td>
                        
                    <td>
                        <a href="../actions/ticketVerifier-Update.php?id=<?= $ticket['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                        <form action="../actions/ticketVerifier-delete.php" method="POST" class="d-inline">
