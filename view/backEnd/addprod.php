    ...
    ?>
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="tables-prod.php">PRODUITS</a></li>
        </ol>
      </nav>
...
if(!empty($_FILES['image']['name'])){
  ...
  move_uploaded_file($_FILES['image']['tmp_name'],'../uplaod/produit/'.$filename);
                ...
                if(!empty($nom) && !empty($prix) && !empty($categorie)){
                    ...
                    $sqlState->execute([$nom, $prix, $discount, $categorie, $date,$description,$filename]);
                    }catch(Exeption $e){
                    ...
                    <div class="alert alert-success" role="alert">
                        le produit <?php echo $nom ?> est bien ajoutee.
                    </div>
                    <?php
                }else{
                    ?>
            ...
            <div class="card-body">
              ...
              <div class="container">
                ...
                <div class="admin-product-form-container">
                  ...
                  <input type="text" placeholder="NOM PRODUITS" class="form-control" required  required placeholder="Available Places" name="nom" class="box">
                ...
                <div class="row mb-3">
                  ...
                  <input type="number" placeholder="PRIX PRODUITE"  class="form-control" step="0.1" name="prix" min="0">
                ...
                <div class="row mb-3">
                  ...
                  <input type="number" value="0" placeholder="DISCOUNT PRODUITE"  class="form-control" name="discount" min="0" max="90">
...
?>
              ...
              <!--  <div class="row mb-3">
                  ...
                  <textarea  class="form-control" name="description"  class="box"> </textarea>
                      ...
                      <input type="submit" class="btn btn-success btn-lg" name="ajouter" value="AJOUTER PRODUITS">
