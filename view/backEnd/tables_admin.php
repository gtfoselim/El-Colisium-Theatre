   ...
   <section class="section">
    ...
    ?>
        ...
        <tr>
                                                ...
                                                <td><?= $Admin['firstname_admin']; ?></td>
                                                <td><?= $Admin['lastname_admin']; ?></td>
                                                <td><?= $Admin['password_admin']; ?></td>
                                                <td><?= $Admin['email_admin']; ?></td>
                                                <td><?= $Admin['phone_admin']; ?></td>
                                                <td><?= $Admin['poste_admin']; ?></td>
                                                <td> <img src="../images/<?php echo $Admin['photo_admin']; ?>" alt="" width="50" height="50"></td>
            
            <td> <a href="../actions/Admin-delete.php?id_admin= <?= $Admin['id_admin'];?>"><button class="btn btn-danger btn-sm">delete</button></a></td>
            <td><form action="../actions/Admin-Update.php">
    ...
    ?>
              ...
              <a href="forms-elements.php"><button  class="btn btn-primary ">ADD ADMIN</button></a>
              <a href="pdf_admin.php"><button  class="btn btn-primary ">PDF</button></a>
            </div>
          </div>
