...
if (isset($_GET['idd'])) {
    $listeSolution = $SolutionC->recherche($_GET['idd']);}
else if(isset($_POST['tri'])) {
    $listeSolution = $SolutionC->triSolution();
 }else {
        $listeSolution = $SolutionC->afficherSolution();
 }
?>
...
/*---------------------------------------------------------------*/?>
 ...
 src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script> 
    ...
    <div class="pagetitle">
      ...
      <h1>LISTES DES SOLUTIONS</h1>

      <!--<button onclick="generatePDF()">Générer un PDF</button>
      <form action="generate_pdf.php" method="post">
  <button type="submit">Generate PDF</button>
</form>-->
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="ajouterSolution.php">Home</a></li>
    ...
    <h5><a href="excel.php" class="btn btn-info">Fichier Excel</a></h5>
</div>
              ...
              <table class="table datatable">
                ...
                <thead>
                  <tr>
                    <th scope="col">ID_Solution</th>
                    <th scope="col">DATE_RESOLUTION</th>
                ...
                <?php
    	foreach ($listeSolution as $Solution){
    ?>
        ...
        <tr>
        <td><?php echo $Solution['ID_S']; ?></td>
            <td><?php echo $Solution['DATE_RESOLUTION']; ?></td>
            <td><?php echo $Solution['DESCRIPTION']; ?></td>
            <td><?php echo $Solution['ID_REC']; ?></td>
           
            <td><form method="POST" action="../actions/modifierSolution.php">
                    <input type="submit" name="Modifier" value="Modifier">
                    <input type="hidden" value=<?PHP echo $Solution['ID_S']; ?> name="ID_S">
                </form></td>
          <td><a href="../actions/supprimerSolution.php?ID_S=<?php echo $Solution['ID_S']?>" class="btn btn-danger btn-lg" ><i class="bi bi-trash"></i> </a></td>
