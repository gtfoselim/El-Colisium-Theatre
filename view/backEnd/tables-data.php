      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">G.SELIM</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>GHAZOUANI MED SELIM</h6>
   ...
   <section class="section">
    ...
    ?>
        ...
        <td><?= $User['id']; ?></td>
            ...
            <td> <a href="../actions/User-delete.php?id= <?= $User['id'];?>"><button class="btn btn-danger btn-sm">delete</button></a>
             <td><form action="../actions/User-Update.php">
           ...
           <td><?php 
                ...
                {
                    ?>
                                    <a href="../actions/ban.php?id=<?php echo $User['id']; ?>&active=<?php echo $User['active']; ?>"><button class="btn btn-danger btn-sm">Ban </button></a>
                                    <?php 
                ...
                {
                    ?>
                                    <a href="../actions/ban.php?id=<?php echo $User['id']; ?>&active=<?php echo $User['active']; ?>"><button class="btn btn-danger btn-sm">Unban</button></a>
    ...
    ?>
              ...
              <a href="forms-elements.php"><button  class="btn btn-primary ">ADD PROFILE</button></a>
              <a href="pdf_user.php"><button  class="btn btn-primary ">PDF</button></a>
              <a href="stat.php"><button  class="btn btn-primary ">STAT</button></a>
            </div>
          </div>
