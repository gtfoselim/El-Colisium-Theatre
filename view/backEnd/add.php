    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="afficher.php">
              <i class="bi bi-circle"></i><span>Event Tables</span>
            </a>
            ...
            <div class="card-body">
              ...
              <form method="POST" action ="" id ="myform">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="" class="form-control" maxlength="25"  placeholder="Place your Name " name ="nom" id="nom">
                    <br>
                   <span id="error"></span>
                   <br>
                  </div>
                ...
                <div class="row mb-3">
                 ...
                 <div class="col-sm-10">
                    <select name ="categorie" id="categorie" class="form-select" aria-label="Default select example">
                      <option selected name ="categorie" id="categorie">Open this select menu</option>
...
-->
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 100px"  placeholder="Main Actors " name ="actors" id="actors" ></textarea>
                    <br>
                   <span id="error4"></span>
                   <br>
                  </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input  class="form-control"  placeholder=" Ticket 's Price" name ="price" id="price">
                    <br>
                   <span id="error5"></span>
                   <br>
                  </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input  class="form-control"  placeholder="Available Places" name ="tickets" id="tickets">
                    <br>
                   <span id="error6"></span>
                   <br>
                  </div>
               ...
               <script>
                  ...
                  myform.addEventListener('submit',function(e){
                    ...
                    let myinput4=document.getElementById("actors");
                    if(myinput4.value.trim() ==''){
                      let myerror4=document.getElementById("error4");
                      myerror4.innerHTML="le champs actors doit etre rempli";
                      myerror4.style.color="red";
                       e.preventDefault();
                    } 
                    let myinput5=document.getElementById("price");
                    if(myinput5.value.trim() ==''){
                      let myerror5=document.getElementById("error5");
                      myerror5.innerHTML="le champs Price doit etre rempli";
                    ...
                    let myinput6=document.getElementById("tickets");
                    if(myinput6.value.trim() ==''){
                      let myerror6=document.getElementById("error6");
                      myerror6.innerHTML="le champs Tickets doit etre rempli";
