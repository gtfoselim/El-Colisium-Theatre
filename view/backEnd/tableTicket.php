<?php
    ...
    $list = $reservationTicketC->listReservationTicket();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tableau Reservation Places</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tableau reservation Places</h5>
              <a href="formAdmin.php" class="btn btn-primary ">Add Reservation</a>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th>seats Reserver</th>
                    <th scope="col">Actions</th>
                  </tr>
                </thead>
                <tbody>
                <?php 
                    foreach($list as $reservationTicket)
                    {
                ?>
                <tr>
                    <th scope="row"><?= $reservationTicket['idReservation']; ?></th>
                    <td><?= $reservationTicket['CIN']; ?></td>
                    <td><?= $reservationTicket['nom']; ?></td>
                    <td><?= $reservationTicket['prenom']; ?></td>
                    <td><?= $reservationTicket['email']; ?></td>
                    <td><?= $reservationTicket['nomEvenement']; ?></td>
                    <td><?= $reservationTicket['dateReservation']; ?></td>
                    <td><?= $reservationTicket['seatsReserver']; ?></td>
                    <td>
                        <a href="../actions/reservationTicket-Update.php?idReservation=<?= $reservationTicket['idReservation']; ?>" class="btn btn-success btn-sm">Edit</a>
                        <form action="../actions/reservationTicket-delete.php" method="POST" class="d-inline">
                            <button type="submit" name="delete_reservation" value="<?=$reservationTicket['idReservation'];?>" class="btn btn-danger btn-sm">Delete</button>
                        </form>
                        <a href="../actions/verificationTicket.php?idReservation=<?= $reservationTicket['idReservation']; ?>" class="btn btn-success btn-sm">verify</a>
                    </td>
                </tr>
                <?php
                    }
