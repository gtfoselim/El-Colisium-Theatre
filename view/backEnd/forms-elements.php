...
if(isset($_POST['nom'],$_POST['prix'],$_POST['stock'])){
  $p=new produit($_POST['nom'],$_POST['prix'],$_POST['stock']);
  $pr->addproduit($p);
...
/*if ( 
    ...
    if (
        ...
        $produits = new produits$produits(
            null,
            $_POST['nom'],
            $_POST['prix'],
        ...
        $produitsC->addproduits$produitst($produits);
    ...
    <section class="section">
      <div class="row">
        ...
        <!--<div class="col-lg-6">-->
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Profil List</h5>
              ...
              <div class="container">
                ...
                <div class="admin-product-form-container">
                   ...
                   <form action="../actions/adduser.php" method="POST" id="formUser" >
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3">
              ...
              <small>error message</small>
                ...
                <div class="row mb-3">
                  ...
                  <input type="file"  name="image"   class="form-control"   class="box"> 
                  </div>
                </div> -->
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                              ...
                              <input type="submit" class="btn" name="ADD PRODUCT" value="ADD PROFILE">
