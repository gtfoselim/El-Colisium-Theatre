          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action ="" id ="myform">
                ...
                <div class="row mb-3">
                  <label for="inputNom" class="col-sm-2 col-form-label">Event's id</label>
                  <div class="col-sm-10">
                    <input type="" class="form-control" maxlength="25"  placeholder="Place event 's id  " name ="id_even" id="id_even">
                    <br>
                   <span id="error2"></span>
                   <br>
                  </div>
               ...
               <!--<div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label" name="imagee">Picture Upload</label>
                  <div class="col-sm-10">
...
<div class="row mb-3">
                  <label for="inputimagee" class="col-sm-2 col-form-label">Picture</label>
                  <div class="col-sm-10">
                    <input type="" class="form-control" maxlength="25"  placeholder="null for the moment  " name ="imagee" id="imagee">
               ...
               <script>
                  ...
                  myform.addEventListener('submit',function(e){
                    ...
                    let myinput2=document.getElementById("id_even");
                    if(myinput2.value.trim() ==''){
                      let myerror2=document.getElementById("error2");
                      myerror2.innerHTML="Ce champs  doit etre rempli";
