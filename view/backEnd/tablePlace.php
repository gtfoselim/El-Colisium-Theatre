<?php
    ...
    $listReservationPlace = null;
    $reservationPlaceC = new ReservationPlaceC();
    $listReservation = $reservationPlaceC->listReservationPlace();
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="" alt="">
        <span class="d-none d-lg-block">EL Colisium</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">M. FGAIER</span>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tableau Reservation Espace</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tableau reservation Espace</h5>
              <a href="formAdminPlace.php" class="btn btn-primary ">Add Reservation</a>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Nombre de personnes estime</th>
                ...
                <tbody>
                <?php 
                    foreach($listReservation as $reservationPlace)
                    {
                ?>
                <tr>
                    <th scope="row"><?= $reservationPlace['idReservation']; ?></th>
                    <td><?= $reservationPlace['CIN']; ?></td>
                    <td><?= $reservationPlace['nom']; ?></td>
                    <td><?= $reservationPlace['prenom']; ?></td>
                    <td><?= $reservationPlace['email']; ?></td>
                    <td><?= $reservationPlace['typeEvenement']; ?></td>
                    <td><?= $reservationPlace['nomEvenement']; ?></td>
                    <td><?= $reservationPlace['dateEvenement']; ?></td>
                    <td><?= $reservationPlace['nbPersonneEstime']; ?></td>
                    <td><?= $reservationPlace['prixTicket']; ?></td>
                    <td>
                        <a href="../actions/reservationPlace-Update.php?idReservation=<?= $reservationPlace['idReservation']; ?>" class="btn btn-success btn-sm">Edit</a>
                        <form action="../actions/reservationPlace-delete.php" method="POST" class="d-inline">
                            <button type="submit" name="delete_reservation" value="<?=$reservationPlace['idReservation'];?>" class="btn btn-danger btn-sm">Delete</button>
                        </form>
                    </td>
                </tr>
                <?php
