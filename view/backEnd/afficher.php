  ...
  <main id="main" class="main">
    ...
    ?>
        ...
        <tr>
            <td><?= $even['id']; ?></td>
            <td> <?= $even['nom']; ?> </td>
            <td><?php echo ($even['categorie']); ?></td>
            <td> <?php echo ($even['doe']); ?></td>
            <td> <?php echo ($even['toe']); ?></td>
            <td> <?php echo ($even['actors']); ?></td>
            <td> <?php echo ($even['price']); ?></td>
            <td> <?php echo ($even['tickets']); ?></td>
            <td> <a href="../actions/delete.php?id= <?= $even['id'];?>">delete</a></td>
            <td> <a href="../actions/test3.php ?id= <?= $even['id'];?>"> update </a> </td>
    ...
    ?>
              ...
              <a href="pdf_events.php  " class="card-title row" style="text-align: center; display: block;" > PDF </a>
              <a href="stat2.php"><button  class="btn btn-primary ">STAT</button></a>
            </div>
