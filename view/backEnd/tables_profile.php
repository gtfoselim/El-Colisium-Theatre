  ...
  <main id="main" class="main">
   ...
   <section class="section">
    ...
    ?>
        ...
        <tr>
                                                <td><?= $Profile['id_admin']; ?></td>
                                                <td><?= $Profile['username_admin']; ?></td>
                                                <td><?= $Profile['firstname_admin']; ?></td>
                                                <td><?= $Profile['lastname_admin']; ?></td>
                                                <td><?= $Profile['password_admin']; ?></td>
                                                <td><?= $Profile['email_admin']; ?></td>
                                                <td><?= $Profile['phone_admin']; ?></td>
                                                <td><?= $Profile['poste_admin']; ?></td>
                                                <td> <img src="../images/<?php echo $Profile['photo_admin']; ?>" alt="" width="50" height="50"></td>
    ...
    ?>
              ...
              <a href="pdf_profile.php"><button  class="btn btn-primary ">PDF</button></a>
