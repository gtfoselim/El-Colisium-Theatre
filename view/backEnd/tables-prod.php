...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      $categories = $pdo->query("SELECT produit.*,categorie.nom as 'categorie_nom' FROM produit INNER JOIN categorie ON produit.id_categorie = categorie.id")->fetchAll(PDO::FETCH_ASSOC);
    ...
    ?>
        ...
        <td><?php echo ($categorie['id']); ?></td>
            ...
            <td> <img class="img-fluid" width="50" height="50"  src="../uplaod/produit/<?php echo ($categorie['image']); ?>" >   </td>
            <td> 
            <a href="../actions/modifier_prod.php?id=<?php echo $categorie['id'] ?>" class="btn btn-success btn-lg"><i class="bi bi-pencil-square"></i></a>
            <a href="../actions/supprimer_prod.php?id=<?php echo $categorie['id'] ?>" class="btn btn-danger btn-lg"><i class="bi bi-trash"></i></a></td>
</td>
    ...
    ?>
     ...
     <a href="addprod.php" class="btn btn-info btn-lg"><i class="bi bi-plus-circle"></i> AJOUTER PRODUITS</a>
     <a href="PDFprod.php" class="btn btn-danger btn-lg"> <i class="fa-solid fa-file-pdf"></i> PDF</a>
     <a href="stat3.php" class="btn btn-warning btn-lg"> <i class="bi bi-bar-chart-line-fill"></i> stat</a>
