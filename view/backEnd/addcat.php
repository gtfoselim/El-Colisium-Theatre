...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
     ...
     <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="http://127.0.0.1/produit/front/index.php" class="active">
              <i class="bi bi-circle"></i><span>FRONT</span>
            </a>
          </li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="addcat.php">Home</a></li>
          <li class="breadcrumb-item">AJOUTER</li>
          <li class="breadcrumb-item active"><a href="tables-cat.php">CATEGORIES</a></li>
        </ol>
      </nav>
      ...
      <?php 
              if(isset($_POST['ajouter'])){
                ...
                if(!empty($nom) && !empty($description)){
                    ...
                    try{
                      $req =$db->prepare('INSERT INTO categorie(nom,description,icone) VALUES(?,?,?)');
                      $req->execute([$nom,$description,$icone]);
                    }catch(Exeption $e){
                    ...
                    <div class="alert alert-success" role="alert">
                        la categorie <?php echo $nom ?> est bien ajoutee.
                    </div>
                    <?php
                }else{
                    ?>
            ...
            <div class="card-body">
              ...
              <div class="container">
                ...
                <div class="admin-product-form-container">
                  ...
                  <input type="text" placeholder="NOM CATEGORIE" class="form-control" required  required placeholder="Available Places" name="nom" class="box">
                ...
                <div class="row mb-3">
                  ...
                  <textarea  class="form-control" name="description"  class="box"> </textarea>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <input type="text" placeholder="AJOUTER ICONE" class="form-control" required  required placeholder="Available Places" name="icone" class="box">
                      ...
                      <input type="submit" class="btn btn-success btn-lg bi bi-plus-circle-dotted"   name="ajouter" value="AJOUTER CATEGORIE">
              ...
              <!--  <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example">
                      ...
                      <option value="1">MONOLOGUE</option>
