  ...
  <main id="main" class="main">
    ...
    ?>
        ...
        <td><?php echo ($categorie['id']); ?></td>
            ...
            <td> <a href="../actions/modifier_categorie.php?id=<?php echo $categorie['id'] ?>" class="btn btn-success btn-lg"><i class="bi bi-pencil-square"></i></a>
            <a href="../actions/supprimer_categorie.php?id=<?php echo $categorie['id'] ?>" class="btn btn-danger btn-lg" ><i class="bi bi-trash"></i> </a></td>
...
<a href="addcat.php" class="btn btn-info btn-lg"> <i class="bi bi-plus-circle"></i> AJOUTER CATEGORIE</a>
<a href="PDFcat.php" class="btn btn-danger btn-lg"> <i class="fa-solid fa-file-pdf"></i> PDF</a>
</div>
