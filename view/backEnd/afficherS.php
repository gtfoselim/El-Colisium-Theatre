  ...
  <main id="main" class="main">
    ...
    ?>
        ...
        <tr>
            ...
            <td> <?php echo ($even['imagee']); ?></td>
            
            <td> <a href="../actions/deleteS.php?id= <?= $even['id'];?>">delete</a></td>
            <td> <a href="../actions/updateS.php ?id= <?= $even['id'];?>"> update </a> </td>
