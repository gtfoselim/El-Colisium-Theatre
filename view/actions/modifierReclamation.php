...
if (
    ...
    if (
     ...
     /* $tmp_name = $_FILES["image"]["tmp_name"];
        ...
        $destination = 'C:/xampp/htdocs/tache reclamation/View/back/NiceAdmin/image/' . $filename;
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../backEnd/afficherReclamation.php">
          <i class="bi bi-person"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../backEnd/afficherSolution.php">
          <i class="bi bi-person"></i>
          <span>Solution</span>
        </a>
      </li><!-- End Profile Page Nav -->
  ...
  <main id="main" class="main">
    ...
    <button><a href="../backEnd/afficherReclamation.php">Retour à la liste des reclamations</a></button>
    <hr>

<div ID_RECLAMATION="error">
        <?php echo $error; ?>
    </div>
    ...
    <form action="" method="POST">
        <table border="1" align="center">                                          
            <tr>
                ...
                <td><input type="number" name="ID_RECLAMATION" id="ID_RECLAMATION"
                        value="<?php echo $Reclamation['ID_RECLAMATION']; ?>" maxlength="20"></td>
            </tr>
            <tr>
                <td>
                    <label for="NAME">NAME:
                ...
                <td>
                    ...
                    <input type="text" name="NAME" id="NAME" value="<?php echo $Reclamation['NAME']; ?>" maxlength="50"></td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="file" name="image" id="image" value="<?php echo $Reclamation['image']; ?>">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="MESSAGE" value="<?php echo $Reclamation['MESSAGE']; ?>">
                </td>
            </tr>            
            <tr>
                <td></td>
