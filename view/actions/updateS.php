...
if ( 
    ...
    if (
        ...
        $evenC->updateSponsor($even, $_POST["id"]);
...
-->
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Event's id </label>
                  <div class="col-sm-10">
                  <input class="form-control"   name ="id_even" value = "<?php echo $p['id_even'];?>" >
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="inputPRIX" class="col-sm-2 col-form-label">Picture </label>
                  <div class="col-sm-10">
                    
                    <input type="" class="form-control"   name ="imagee" value = "<?php echo $p['imagee'];?>" >
