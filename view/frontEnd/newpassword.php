<?php
    ...
    if (
        ...
        if($_POST["password"]==$_POST["testpassword"]) 
{
    if (strlen($_POST["password"])<3)
    {
        echo '<script>alert("password must be more than 8 character")</script>';

    }
    else
    {
        $UserC->setpassword($_SESSION["email"],$_POST["password"]);
...
<html>
    ...
    <body>
       ...
       <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <a href="#book-a-ticket" class="book-a-ticket-btn scrollto">New Password</a>
      ...
      <div class="container">
        ...
        <form action="" method="post" class="php-email-form" id="formUser">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="password" class="form-control" name="testpassword" id="testpassword" placeholder="Confirm Password">
              <i class="bi-check-circle-fill"></i>
              <i class="bi-exclamation-circle-fill"></i>
              <small>error message</small>
            </div>
