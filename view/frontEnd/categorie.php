    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#specials">CATEGORIS | <?php echo $categorie['nom']?> :</a></li>
    ...
    <section id="specials" class="specials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>CATEGORIE:</h2>
          <p><i class="<?php echo $categorie['icone'];?>"></i> | <?php echo $categorie['nom']?></p>
        </div>
        <div class="section-title">
          <h2>produit:</h2>
          <p>NOTRE PRODUITS</p>
...
<div class=" card text-bg-dark card mb-3 col-md-3 m-4">
  ...
  <div class="card-body">
    ...
    <h3 class="card-title"><?php echo $produit->nom ?></h3> <hr>
    <h4 class="card-text"><?php echo $produit->prix ?>$</h4> <hr>
