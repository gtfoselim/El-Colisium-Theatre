...
<html>
    ...
    <body>
       ...
       <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <a href="#book-a-ticket" class="book-a-ticket-btn scrollto">Code</a>
        ...
        <form action="" method="post" class="php-email-form" id="formUser">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="text" name="code" class="form-control" id="code" placeholder="Validation code">
          ...
          <div class="text-center"><button type="submit" name="login">Validate Code</button></div>
